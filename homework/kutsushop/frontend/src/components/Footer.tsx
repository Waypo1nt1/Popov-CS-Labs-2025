          ...
          <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
            <div className="w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
              <ul className="list-disc list-inside space-y-8">
                <li>
                  <a href="http://localhost:5173/viewdata/shoes" className="hover:text-sky-400 transition">
                    Главная
                  </a>
                </li>
                <li>
                  <a href="https://bmstu.ru/" className="hover:text-sky-400 transition">
                    Информация
                  </a>
                </li>
                <li>
            ...
            <div className="w-10/12 m-auto  mt-16 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
              ...
              <span className="block text-gray-300">МГТУ им. Н. Э. Баумана &copy; 2025</span>
